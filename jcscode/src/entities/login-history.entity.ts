...
export class LoginHistory {
  ...
  @Column({ type: 'varchar', length: 50, nullable: true }) auth_method!: string | null;
  @Column({ type: 'varchar', length: 100, nullable: true }) failure_reason!: string | null;
  ...
  @Column({ type: 'varchar', length: 255, nullable: true }) attempted_email!: string | null;
